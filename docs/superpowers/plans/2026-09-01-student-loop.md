...
- [ ] P4.1 Capture → OCR preview. No `phase=handDone` fake. Commit `checkpoint: P4.1 ocr preview on capture`
- [ ] P4.2 맞아요 / 줄만 고치기 / 다시촬영 → `/api/ocr-confirm`. Preview does not fire `ocr_confirm`. Commit `checkpoint: P4.2 ocr confirm three actions`

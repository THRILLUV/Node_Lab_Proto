...
class ProviderSettings:
    ...
    # NodeLab 확정 스택 (ADR-019). reasoning/ocr = Gemini 3.7 Flash (OCR·CAT·블라인드),
    # fast = DeepSeek V4 Flash (변형 생성·힌트). baseline은 평가 전용으로 유지.
    reasoning_model_name: str = "gemini-3.7-flash"
    fast_model_name: str = "deepseek-v4-flash"
    ocr_model_name: str = "gemini-3.7-flash"
    baseline_glm5_model_name: str = "gemini-3.7-flash"
    baseline_kimi_model_name: str = "deepseek-v4-flash"
    detection_model_name: str = "gemini-3.7-flash"
